...
SWIFT_PROTOCOL("_TtP4Roam9Connector_")
@protocol Connector
...
typedef SWIFT_ENUM(NSInteger, RoamMqttConnectionType, open) {
  RoamMqttConnectionTypeWSS = 0,
  RoamMqttConnectionTypeSSL = 1,
  RoamMqttConnectionTypeTCP = 2,
};


SWIFT_CLASS("_TtC4Roam17RoamMqttConnector")
@interface RoamMqttConnector : NSObject <Connector>
